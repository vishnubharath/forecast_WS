...
public class LeaveServiceImpl implements LeaveService {
	...
	public LeaveResponse getLeaveByEmployeeId(Integer empId) {
		...
		List<LeaveVO> leaves = leaveDao.getLeaveByEmployeeId(empId, currentMonth, year);
	...
	public Response insertForecastLeave(HashMap<String, List<LeaveVO>> forecastLeaves) {
		...
		try {
			...
			leaveDao.deleteForecastLeave(empId.toString(), updatedOn, year);
			leaveDao.insertForecastLeave(forecasts, updatedOn, year);
		} catch (Exception e) {
	...
	public String insertActualLeave(ArrayList<LeaveVO> actualLeaves) {
		...
		try {
			...
			leaveDao.deleteActualLeave(empId.toString(), updatedOn, year);
			leaveDao.insertActualLeave(actuals, updatedOn, year);
		} catch (Exception e) {
			response.append("message : ERROR  while saving actual Leaves the data");
			e.printStackTrace();
		}
	...
	public List<LeaveVO> getAllEmpLeaves() {
		...
		List<LeaveVO> lresponselist = leaveDao.getAllEmpLeaves();
